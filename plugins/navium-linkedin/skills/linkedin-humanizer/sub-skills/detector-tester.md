...
- **Upstream team test**: same article, three detectors, scores **82% / 100% / 50%**. That is a 50-point spread on identical text.
...
- As a follow-up to the upstream author's controversial detector post — paste any flagged text, run it, screenshot the divergence
